...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    button1.whileTrue(new TurnLedOn(m_onboardIO))
      .whileFalse(new TurnLedOff(m_onboardIO));

    // Example of how to use the onboard IO
    Trigger onboardButtonA = new Trigger(m_onboardIO::getButtonAPressed);
    onboardButtonA
        .whileTrue(new PrintCommand("Button A Pressed"))
        .whileFalse(new PrintCommand("Button A Released"));
